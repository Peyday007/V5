...
export function NeedsYouView({
   ...
   */
  /*
   * Empty means *nothing* is waiting, and a software change waiting to be
   * authorized is waiting. Counting only `requests` here would put "nothing
   * needs your decision" directly above a card that has to be answered before
   * anything can run — §29's own defect, at the panel it was found on.
   */
  const nothingWaiting = state.phase === 'EMPTY' && software.length === 0;
