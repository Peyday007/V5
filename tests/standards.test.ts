...
function claim(overrides: Partial<ResearchClaim> = {}): ResearchClaim {
  return {
    ...
    capabilityQualifier: null,
    capabilityBasis: null,
    capabilityAmountLowMinor: null,
    capabilityAmountHighMinor: null,
    capabilityCurrency: null,
    ...
    puzzleSubject: null,
    puzzleFormat: null,
    puzzleProductClass: null,
    puzzleValue: null,
    puzzleAmountCents: null,
    puzzleCurrency: null,
